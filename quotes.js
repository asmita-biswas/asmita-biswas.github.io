const localQuotes = [
  ...
  {
    text: 'Anyone can find the dirt in someone. Be the one that finds the gold.',
  ...
  {
    text: 'When things are beyond your control and there is nothing you can do,why worry',
    author: 'Gaur Gopal Das',
  },
  {
